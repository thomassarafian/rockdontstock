...
Sneaker.create(name: "Jordan 12 Retro Low Easter (2021)", size: 44, price: 200, condition: 5, box: "OG Box", extras: "lacets", state: 1, user_id: 47)
Sneaker.create(name: "Jordan 5 Retro White Stealth (2021)", size: 42, price: 125, condition: 8, box: "OG Box", extras: "lacets", state: 1, user_id: 47)
